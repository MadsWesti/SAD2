...
\section{Future Work}
Odd Sketch is good when you want to improve precision when the Jaccard similarity index is close to 1. It can provide a short list and ranking over the most similar items. Looking at b-Bit versus Odd Sketch.\\

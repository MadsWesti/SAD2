...
We would like to find the most similar actor to replace our unavailable lead actor. To do this we first talk about measuring similarity. 
%\end{mdframed}
...
\todo{Talk about that thing with 0.0000035\% something from ch3}
